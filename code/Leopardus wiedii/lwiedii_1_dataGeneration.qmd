---
title: "Leopardus wiedii Data Generation"
format: 
  html:
    toc: true
    toc-location: right
...
Data generation for *Leopardus wiedii* (blobs and rasters).
...
data_carnivores_PO %>% filter(species == 'Leopardus wiedii') %>% filter(year>=2000) %>% 
  filter(!(decimalLongitude>(-40) & dataset =='occurrencePoints_NeotropCarnivores')) %>% 
...
# Leopardus wiedii
PO_lwiedii_time1_raster <- calculate_PO_sp_period_raster(PO, 'Leopardus wiedii', latam_raster, 'time1')
PO_lwiedii_time2_raster <- calculate_PO_sp_period_raster(PO, 'Leopardus wiedii', latam_raster, 'time2')
```
...
# blobs
saveRDS(PA_lwiedii_time1_blobs, 'data/species_POPA_data/PA_lwiedii_time1_blobs.rds')
saveRDS(PA_lwiedii_time2_blobs, 'data/species_POPA_data/PA_lwiedii_time2_blobs.rds')

# presence-only rasters
terra::writeRaster(PO_lwiedii_time1_raster, 'data/species_POPA_data/PO_lwiedii_time1_raster.tif', overwrite=TRUE)
terra::writeRaster(PO_lwiedii_time2_raster, 'data/species_POPA_data/PO_lwiedii_time2_raster.tif', overwrite=TRUE)

saveRDS(data_PA_time1_time2, 'data/species_POPA_data/data_lwiedii_PA.rds')
saveRDS(data_PO_time1_time2, 'data/species_POPA_data/data_lwiedii_PO.rds')
```
