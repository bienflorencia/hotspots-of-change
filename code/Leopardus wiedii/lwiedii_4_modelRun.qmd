...
lwiedii_expert_blob_time1 <- readRDS('data/lwiedii_expert_blob_time1.rds')
lwiedii_expert_blob_time2 <- readRDS('data/lwiedii_expert_blob_time2.rds')
...
# Presence-only data
lwiedii_expert_gridcell <- readRDS('data/lwiedii_expert_gridcell.rds')
...
saveRDS(lwiedii_model, 'D:/Flo/JAGS_models/lwiedii_model.rds')
```
