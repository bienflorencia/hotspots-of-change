...
Data preparation for modelling for *Leopardus wiedii*, with the covariates `bio7`, `bio9`, `npp`, and `nontree` (selected in the previous step). 
...
env <- c(bio[[c('bio_7','bio_9')]], nontree, npp) %>% 
...
bio_9.plot <- tm_graticules(alpha = 0.3) +  
    tm_shape(env_100k_unscaled[["bio_9"]]) +
