...
hyagouaroundi_expert_blob_time1 <- readRDS('data/species_POPA_data/hyagouaroundi_expert_blob_time1.rds')
hyagouaroundi_expert_blob_time2 <- readRDS('data/species_POPA_data/hyagouaroundi_expert_blob_time2.rds')

PA_time1 <- readRDS('data/species_POPA_data/data_hyagouaroundi_PA_time1.rds') %>%
...
PA_time2 <- readRDS('data/species_POPA_data/data_hyagouaroundi_PA_time2.rds') %>%
  cbind(expert=hyagouaroundi_expert_blob_time2) %>% 
  filter(!is.na(env.bio_7) &!is.na(env.bio_15) & !is.na(env.npp) & !is.na(env.elev) & !is.na(expert)) # remove NA's

# Presence-only data
hyagouaroundi_expert_gridcell <- readRDS('data/species_POPA_data/hyagouaroundi_expert_gridcell.rds')

PO_time1 <- readRDS('data/species_POPA_data/data_hyagouaroundi_PO_time1.rds') %>%
...
PO_time2  <- readRDS('data/species_POPA_data/data_hyagouaroundi_PO_time2.rds')  %>%
  cbind(expert=hyagouaroundi_expert_gridcell$dist_exprt) %>% 
  filter(!is.na(env.bio_7) &!is.na(env.bio_15) & !is.na(env.npp) & !is.na(env.elev) & !is.na(acce) & !is.na(count) & !is.na(expert)) # remove NA's
...
### Probability of occurrence of *Herpailurus yagouaroundi*
...
tmap::tmap_save(tm = time1MAP, filename = 'docs/figs/time1MAP_SR_hyagouaroundi.svg', device = svglite::svglite)
tmap::tmap_save(tm = time2MAP, filename = 'docs/figs/time2MAP_SR_hyagouaroundi.svg', device = svglite::svglite)
```
...
diffMAP.SD
tmap::tmap_save(tm = diffMAP.SD, filename = 'docs/figs/diffMAP_SD_hyagouaroundi.svg', device = svglite::svglite)
...
delta.A.plot
ggsave(delta.A.plot, filename='docs/figs/delta_A_hyagouaroundi.svg', device = 'svg', dpi=300)
```
