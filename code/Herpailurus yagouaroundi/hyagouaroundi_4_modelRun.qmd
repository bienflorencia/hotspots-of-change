---
title: "Herpailurus yagouaroundi Model Run"
format: 
  html:
    toc: true
    toc-location: right
...
hyagouaroundi_model <- R2jags::jags(data=jags.data,
                                model.file='models/hyagouaroundi_model.txt',
...
saveRDS(hyagouaroundi_model, 'models/JAGS_models/hyagouaroundi_model.rds')
```
