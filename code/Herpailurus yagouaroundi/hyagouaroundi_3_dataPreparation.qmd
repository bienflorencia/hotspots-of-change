...
PO_hyagouaroundi_time1_raster <- terra::rast('data/PO_hyagouaroundi_time1_raster.tif')
PO_hyagouaroundi_time2_raster <- terra::rast('data/PO_hyagouaroundi_time2_raster.tif')

# blobs
PA_hyagouaroundi_time1_blobs <- readRDS('data/PA_hyagouaroundi_time1_blobs.rds')
PA_hyagouaroundi_time2_blobs <- readRDS('data/PA_hyagouaroundi_time2_blobs.rds')
```
