...
gam.formula <- formula(count ~ env.bio_16 + 
                               env.bio_19 + 
                               env.npp + 
                               env.tree +
                               expert +
...
PA.X <- cbind('(Intercept)'= 1, 
              ...
              'env.bio_19' = PA_time1_time2$env.bio_19,
...
PO.X <- cbind('(Intercept)'= 1, 
              ...
              'env.bio_19' = PO_time1_time2$env.bio_19,
...
saveRDS(cthous_model, 'models/JAGS_models/cthous_model.rds')
```
