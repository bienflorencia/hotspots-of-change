---
title: "Cerdocyon thous Model Run"
format: 
  html:
    toc: true
    toc-location: right
...
Model run for *Cerdocyon thous* with the data prepared in the previous step (including species and covariates data).  
...
PA.X <- cbind('(Intercept)'= 1, 
              ...
              'env.bio_4' = PA_time1_time2$env.bio_4,
              'env.tree' = PA_time1_time2$env.tree,
              'env.urban' = PA_time1_time2$env.urban,
...
PO.X <- cbind('(Intercept)'= 1, 
              ...
              'env.bio_4' = PO_time1_time2$env.bio_4,
              'env.tree' = PO_time1_time2$env.tree,
              'env.urban' = PO_time1_time2$env.urban,
...
cthous_model <- R2jags::jags(data=jags.data,
                                model.file='models/cthous_model.txt',
...
saveRDS(cthous_model, 'big_data/cthous_model.rds')
```
