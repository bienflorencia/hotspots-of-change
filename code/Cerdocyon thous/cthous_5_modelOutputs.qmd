...
fitted.model <- readRDS('models/JAGS_models/cthous_model.rds') # deleted after model output
...
diffMAP.SD
tmap::tmap_save(tm = diffMAP.SD, filename = 'docs/figs/diffMAP_SD_cthous.svg', device = svglite::svglite)
```
...
delta.A.plot
ggsave(delta.A.plot, filename='docs/figs/delta_A_cthous.svg', device = 'svg', dpi=300)
```
