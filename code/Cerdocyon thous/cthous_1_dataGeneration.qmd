---
title: "Cerdocyon thous Data Generation"
format: 
  html:
    toc: true
    toc-location: right
...
# Cerdocyon thous
PO_cthous_time1_raster <- calculate_PO_sp_period_raster(PO, 'Cerdocyon thous', Latam.raster, 'time1')
PO_cthous_time2_raster <- calculate_PO_sp_period_raster(PO, 'Cerdocyon thous', Latam.raster, 'time2')
```
...
# blobs
saveRDS(PA_cthous_time1_blobs, 'data/PA_cthous_time1_blobs.rds')
saveRDS(PA_cthous_time2_blobs, 'data/PA_cthous_time2_blobs.rds')

# presence-only rasters
terra::writeRaster(PO_cthous_time1_raster, 'data/PO_cthous_time1_raster.tif', overwrite=TRUE)
terra::writeRaster(PO_cthous_time2_raster, 'data/PO_cthous_time2_raster.tif', overwrite=TRUE)

saveRDS(data_PA_time1_time2, 'data/data_cthous_PA.rds')
saveRDS(data_PO_time1_time2, 'data/data_cthous_PO.rds')
```
