---
title: "speciesLatin Variable Selection"
format: 
  html:
    toc: true
    toc-location: right
...
Variable Selection for *speciesLatin*, using the data generated in the previous step.
...
PA_time1 <- readRDS('data/PA_speciesAbrev_time1_blobs.rds')%>% ungroup()
PA_time2 <- readRDS('data/PA_speciesAbrev_time2_blobs.rds')%>% ungroup()
