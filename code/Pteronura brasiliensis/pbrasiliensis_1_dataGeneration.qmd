---
title: "Pteronura brasiliensis Data Generation"
format: 
  html:
    toc: true
    toc-location: right
...
# Presence-only
data_carnivores_PO %>% filter(species == 'Pteronura brasiliensis') %>% filter(year>=2000) %>% 
...
# Presence-absence
data_carnivores_PA %>% filter(species == 'Pteronura brasiliensis' & presence ==1) %>% 
...
PA_pbrasiliensis_time1_blobs <- calculate_PA_sp_blobs(PA, blobs_efforttime_time1, 'Pteronura brasiliensis', 'time1')
PA_pbrasiliensis_time2_blobs <- calculate_PA_sp_blobs(PA, blobs_efforttime_time2, 'Pteronura brasiliensis', 'time2')
```
...
data_PA_time1_time2 <- rbind(PA_pbrasiliensis_time1_blobs %>% mutate(period='time1'), 
                             PA_pbrasiliensis_time2_blobs %>% mutate(period='time2'))
...
# Pteronura brasiliensis
PO_pbrasiliensis_time1_raster <- calculate_PO_sp_period_raster(PO, 'Pteronura brasiliensis', Latam.raster, 'time1')
PO_pbrasiliensis_time2_raster <- calculate_PO_sp_period_raster(PO, 'Pteronura brasiliensis', Latam.raster, 'time2')
```
...
# blobs
saveRDS(PA_pbrasiliensis_time1_blobs, 'data/PA_pbrasiliensis_time1_blobs.rds')
saveRDS(PA_pbrasiliensis_time2_blobs, 'data/PA_pbrasiliensis_time2_blobs.rds')

# presence-only rasters
terra::writeRaster(PO_pbrasiliensis_time1_raster, 'data/PO_pbrasiliensis_time1_raster.tif', overwrite=TRUE)
terra::writeRaster(PO_pbrasiliensis_time2_raster, 'data/PO_pbrasiliensis_time2_raster.tif', overwrite=TRUE)


saveRDS(data_PA_time1_time2, 'data/data_pbrasiliensis_PA.rds')
saveRDS(data_PO_time1_time2, 'data/data_pbrasiliensis_PO.rds')
```
