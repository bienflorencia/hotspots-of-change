...
# Pteronura brasiliensis
PO_pbrasiliensis_time1_raster <- calculate_PO_sp_period_raster(PO, 'Pteronura brasiliensis', latam_raster, 'time1')
PO_pbrasiliensis_time2_raster <- calculate_PO_sp_period_raster(PO, 'Pteronura brasiliensis', latam_raster, 'time2')
```
...
terra::writeRaster(PO_pbrasiliensis_time1_raster, 'data/species_POPA_data/PO_pbrasiliensis_time1_raster.tif', overwrite=TRUE)
