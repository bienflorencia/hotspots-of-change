---
title: "Pteronura brasiliensis Variable Selection"
format: 
  html:
    toc: true
    toc-location: right
...
PA_time1 <- readRDS('data/PA_pbrasiliensis_time1_blobs.rds')%>% ungroup()
PA_time2 <- readRDS('data/PA_pbrasiliensis_time2_blobs.rds')%>% ungroup()
