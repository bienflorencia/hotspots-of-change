---
title: "Pteronura brasiliensis Data Preparation"
format: 
  html:
    toc: true
    toc-location: right
...
PO_pbrasiliensis_time1_raster <- terra::rast('data/PO_pbrasiliensis_time1_raster.tif')
PO_pbrasiliensis_time2_raster <- terra::rast('data/PO_pbrasiliensis_time2_raster.tif')

# blobs
PA_pbrasiliensis_time1_blobs <- readRDS('data/PA_pbrasiliensis_time1_blobs.rds')
PA_pbrasiliensis_time2_blobs <- readRDS('data/PA_pbrasiliensis_time2_blobs.rds')
```
...
PO_pbrasiliensis.countries <- Latam.raster.countries %>% classify(cbind(NaN, NA))
...
PA_pbrasiliensis.env.time1 <- terra::extract(x = env, y = vect(PA_pbrasiliensis_time1_blobs), fun = mean, rm.na=T) %>% 
  mutate(across(where(is.numeric), ~ifelse(is.nan(.), NA, .))) %>% scale()

PA_pbrasiliensis.env.time2 <- terra::extract(x = env, y = vect(PA_pbrasiliensis_time2_blobs), fun = mean, rm.na=T) %>% 
  mutate(across(where(is.numeric), ~ifelse(is.nan(.), NA, .))) %>% scale()
...
saveRDS(PO_pbrasiliensis_time1.model.data, 'data/data_pbrasiliensis_PO_time1.rds')
saveRDS(PO_pbrasiliensis_time2.model.data, 'data/data_pbrasiliensis_PO_time2.rds')
saveRDS(PA_pbrasiliensis_time1.model.data, 'data/data_pbrasiliensis_PA_time1.rds')
saveRDS(PA_pbrasiliensis_time2.model.data, 'data/data_pbrasiliensis_PA_time2.rds')
```
