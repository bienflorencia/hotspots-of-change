...
Model run for *speciesLatin* with the data prepared in the previous step (including species and covariates data).  
...
gam.formula <- formula(count ~ env.cov.1 + 
                               env.cov.2 + 
                               env.cov.3 + 
                               env.cov.4 +
                               expert +
...
PA.X <- cbind('(Intercept)'= 1, 
              'env.cov.1' = PA_time1_time2$env.cov.1,
              'env.cov.2' = PA_time1_time2$env.cov.2,
              'env.cov.3' = PA_time1_time2$env.cov.3,
              'env.cov.4' = PA_time1_time2$env.cov.4,
              'expert' = PA_time1_time2$expert,
              jagam.PA.time1, 
              jagam.PA.time2)

PO.X <- cbind('(Intercept)'= 1, 
              'env.cov.1' = PO_time1_time2$env.cov.1,
              'env.cov.2' = PO_time1_time2$env.cov.2,
              'env.cov.3' = PO_time1_time2$env.cov.3,
              'env.cov.4' = PO_time1_time2$env.cov.4,
...
', file = 'models/speciesAbrev_model.txt')
```
...
speciesAbrev_model <- R2jags::jags(data=jags.data,
                                model.file='models/speciesAbrev_model.txt',
...
saveRDS(speciesAbrev_model, 'big_data/speciesAbrev_model.rds')
```
