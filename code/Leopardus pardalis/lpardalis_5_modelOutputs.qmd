---
title: "Leopardus pardalis Model Outputs"
format: 
  html:
    toc: true
    toc-location: right
...
fitted.model <- readRDS('D:/Flo/HNC_models/lpardalis_model.rds') # deleted after model output
...
} else lpardalis.new.pal <- lpardalis.pal[-c(absent_classes[i])]
