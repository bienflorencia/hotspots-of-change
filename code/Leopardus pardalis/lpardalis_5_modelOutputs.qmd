...
L.fitted.model.b <- plab("b", 
                         list(Covariate = c('Intercept', 
                                            ...
                                            'env.tree', 
                                            'expert',
                                            sprintf('spline%i', 1:20)))) # changes with n.spl
...
caterpiller.params <- fitted.model.ggs.b %>%
  ...
  mutate(Parameter=as.factor(ifelse(Parameter=='env.bio_10', 'name bio_10',
                                    ifelse(Parameter=='env.tree', 'name bio_17',
                                           ifelse(Parameter=='env.npp', 'name npp',
                                                  ifelse(Parameter=='env.bio_17', 'name tree', Parameter)))))) %>% 
