...
PA_time1 <- readRDS('data/data_lpardalis_PA_time1.rds') %>%
  ...
  filter(!is.na(env.bio_10) &!is.na(env.bio_17) & !is.na(env.tree) & !is.na(env.npp) & !is.na(expert)) # remove NA's
...
PO_time1 <- readRDS('data/data_lpardalis_PO_time1.rds') %>%
  ...
  filter(!is.na(env.bio_10) &!is.na(env.bio_17) & !is.na(env.tree) & !is.na(env.npp) & !is.na(acce) & !is.na(count) & !is.na(expert)) # remove NA's
