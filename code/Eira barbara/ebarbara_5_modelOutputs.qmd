...
ebarbara_expert_blob_time1 <- readRDS('data/ebarbara_expert_blob_time1.rds')
ebarbara_expert_blob_time2 <- readRDS('data/ebarbara_expert_blob_time2.rds')

PA_time1 <- readRDS('data/data_ebarbara_PA_time1.rds') %>%
...
PA_time2 <- readRDS('data/data_ebarbara_PA_time2.rds') %>%
  cbind(expert=ebarbara_expert_blob_time2) %>% 
  filter(!is.na(env.bio_10) &!is.na(env.bio_17) & !is.na(env.npp) & !is.na(env.nontree) & !is.na(expert)) # remove NA's

# Presence-only data
ebarbara_expert_gridcell <- readRDS('data/ebarbara_expert_gridcell.rds')

PO_time1 <- readRDS('data/data_ebarbara_PO_time1.rds') %>%
...
PO_time2  <- readRDS('data/data_ebarbara_PO_time2.rds')  %>%
  cbind(expert=ebarbara_expert_gridcell$dist_exprt) %>% 
  filter(!is.na(env.bio_10) &!is.na(env.bio_17) & !is.na(env.npp) & !is.na(env.nontree) & !is.na(acce) & !is.na(count) & !is.na(expert)) # remove NA's
