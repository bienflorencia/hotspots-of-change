...
# Eira barbara
PO_ebarbara_time1_raster <- calculate_PO_sp_period_raster(PO, 'Eira barbara', latam_raster, 'time1')
PO_ebarbara_time2_raster <- calculate_PO_sp_period_raster(PO, 'Eira barbara', latam_raster, 'time2')
```
...
# blobs
saveRDS(PA_ebarbara_time1_blobs, 'data/species_POPA_data/PA_ebarbara_time1_blobs.rds')
saveRDS(PA_ebarbara_time2_blobs, 'data/species_POPA_data/PA_ebarbara_time2_blobs.rds')

# presence-only rasters
terra::writeRaster(PO_ebarbara_time1_raster, 'data/species_POPA_data/PO_ebarbara_time1_raster.tif', overwrite=TRUE)
terra::writeRaster(PO_ebarbara_time2_raster, 'data/species_POPA_data/PO_ebarbara_time2_raster.tif', overwrite=TRUE)

saveRDS(data_PA_time1_time2, 'data/species_POPA_data/data_ebarbara_PA.rds')
saveRDS(data_PO_time1_time2, 'data/species_POPA_data/data_ebarbara_PO.rds')
```
