...
Data preparation for modelling for *Chrysocyon brachyurus*, with the covariates `bio_2`, `bio_14`, `elev`, and `grass` (selected in the previous step).
...
PO_cbrachyurus_time1_raster <- terra::rast('data/PO_cbrachyurus_time1_raster.tif')
PO_cbrachyurus_time2_raster <- terra::rast('data/PO_cbrachyurus_time2_raster.tif')

# blobs
PA_cbrachyurus_time1_blobs <- readRDS('data/PA_cbrachyurus_time1_blobs.rds')
PA_cbrachyurus_time2_blobs <- readRDS('data/PA_cbrachyurus_time2_blobs.rds')
```
...
The following covariates were chosen using the 'variableSelection' script:
 ...
 - `bio_2`: Mean diurnal range (mean of monthly (maxtemp - mintemp))
...
bio_2.plot <- tm_graticules(alpha = 0.3) +  
    tm_shape(env_100k_unscaled[["bio_2"]]) +
...
PO_cbrachyurus.countries <- Latam.raster.countries %>% classify(cbind(NaN, NA))
...
saveRDS(PO_cbrachyurus_time1.model.data, 'data/data_cbrachyurus_PO_time1.rds')
saveRDS(PO_cbrachyurus_time2.model.data, 'data/data_cbrachyurus_PO_time2.rds')
saveRDS(PA_cbrachyurus_time1.model.data, 'data/data_cbrachyurus_PA_time1.rds')
saveRDS(PA_cbrachyurus_time2.model.data, 'data/data_cbrachyurus_PA_time2.rds')
```
