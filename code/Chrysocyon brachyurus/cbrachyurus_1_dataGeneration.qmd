---
title: "Chrysocyon brachyurus Data Generation"
format: 
  html:
    toc: true
    toc-location: right
...
Data generation for *Chrysocyon brachyurus* (blobs and rasters).
...
# Presence-only
data_carnivores_PO %>% filter(species == 'Chrysocyon brachyurus') %>% filter(year>=2000) %>% 
...
# Presence-absence
data_carnivores_PA %>% filter(species == 'Chrysocyon brachyurus' & presence ==1) %>% 
...
PA_cbrachyurus_time1_blobs <- calculate_PA_sp_blobs(PA, blobs_efforttime_time1, 'Chrysocyon brachyurus', 'time1')
PA_cbrachyurus_time2_blobs <- calculate_PA_sp_blobs(PA, blobs_efforttime_time2, 'Chrysocyon brachyurus', 'time2')
```
...
data_PA_time1_time2 <- rbind(PA_cbrachyurus_time1_blobs %>% mutate(period='time1'), 
                             PA_cbrachyurus_time2_blobs %>% mutate(period='time2'))
...
gg_PA_time1 <- ggplot() + 
    ...
    coord_sf(xlim = c(-3500000, 4100000), ylim = c(-4400000, 3000000)) + # st_bbox(cbrachyurus_IUCN)
...
# Chrysocyon brachyurus
PO_cbrachyurus_time1_raster <- calculate_PO_sp_period_raster(PO, 'Chrysocyon brachyurus', latam_raster, 'time1')
PO_cbrachyurus_time2_raster <- calculate_PO_sp_period_raster(PO, 'Chrysocyon brachyurus', latam_raster, 'time2')
```
...
# blobs
saveRDS(PA_cbrachyurus_time1_blobs, 'data/species_POPA_data/PA_cbrachyurus_time1_blobs.rds')
saveRDS(PA_cbrachyurus_time2_blobs, 'data/species_POPA_data/PA_cbrachyurus_time2_blobs.rds')

# presence-only rasters
terra::writeRaster(PO_cbrachyurus_time1_raster, 'data/species_POPA_data/PO_cbrachyurus_time1_raster.tif', overwrite=TRUE)
terra::writeRaster(PO_cbrachyurus_time2_raster, 'data/species_POPA_data/PO_cbrachyurus_time2_raster.tif', overwrite=TRUE)

saveRDS(data_PA_time1_time2, 'data/species_POPA_data/data_cbrachyurus_PA.rds')
saveRDS(data_PO_time1_time2, 'data/species_POPA_data/data_cbrachyurus_PO.rds')
```
