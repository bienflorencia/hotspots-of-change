...
Model run for *SPECIES* with the data prepared in the previous step (including species and covariates data).  
...
SPECIES_model <- R2jags::jags(data=jags.data,
                                 model.file='models/SPECIES_model.txt',
...
saveRDS(SPECIES_model, 'big_data/SPECIES_model.rds')
```
