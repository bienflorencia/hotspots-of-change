...
Data preparation for modelling for *Leopardus wiedii*, with the covariates `bio7`, `bio4`, `npp`, and `nontree` (selected in the previous step).
...
PO_lwiedii_time1_raster <- terra::rast('data/PO_lwiedii_time1_raster.tif')
PO_lwiedii_time2_raster <- terra::rast('data/PO_lwiedii_time2_raster.tif')

# blobs
PA_lwiedii_time1_blobs <- readRDS('data/PA_lwiedii_time1_blobs.rds')
PA_lwiedii_time2_blobs <- readRDS('data/PA_lwiedii_time2_blobs.rds')
```
