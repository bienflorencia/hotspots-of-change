---
title: "Nasua nasua Data Generation"
format: 
  html:
    toc: true
    toc-location: right
...
PA_nnasua_time2_blobs <- calculate_PA_sp_blobs(PA, blobs_efforttime_time2, 'Nasua nasua', 'time2')
```
...
# Nasua nasua
PO_nnasua_time1_raster <- calculate_PO_sp_period_raster(PO, 'Nasua nasua', Latam.raster, 'time1')
PO_nnasua_time2_raster <- calculate_PO_sp_period_raster(PO, 'Nasua nasua', Latam.raster, 'time2')
```
...
# blobs
saveRDS(PA_nnasua_time1_blobs, 'data/PA_nnasua_time1_blobs.rds')
saveRDS(PA_nnasua_time2_blobs, 'data/PA_nnasua_time2_blobs.rds')

# presence-only rasters
terra::writeRaster(PO_nnasua_time1_raster, 'data/PO_nnasua_time1_raster.tif', overwrite=TRUE)
terra::writeRaster(PO_nnasua_time2_raster, 'data/PO_nnasua_time2_raster.tif', overwrite=TRUE)

saveRDS(data_PA_time1_time2, 'data/data_nnasua_PA.rds')
saveRDS(data_PO_time1_time2, 'data/data_nnasua_PO.rds')
```
